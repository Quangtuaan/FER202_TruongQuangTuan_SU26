...
export default function CarList() {
  ...
  const sorted = [...filtered].sort((a, b) => {
    ...
    if (key === 'price') return (a.priceWeekday - b.priceWeekday) * multiplier;
    if (key === 'seats') return (a.seats - b.seats) * multiplier;
  ...
  return (
    <div>
      ...
      >
        ...
        <option value="seats-asc">Seats (Ascending)</option>
        <option value="seats-desc">Seats (Descending)</option>
